...
public class SmothySSH {
    private static Logger logger = LoggerFactory.getLogger(SmothySSH.class);
    ...
    public static void main(String[] args) {
        ...
        String command =  "aws s3 cp foo s3://cassandra-bkp/my-file > cp-progress.log";
